    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 rounded-2xl p-8 space-y-5 shadow-xl">
          <h2 className="text-xl font-semibold">Przypomnij hasło</h2>

          {sent ? (
            <div className="space-y-4">
              <p className="text-green-400 text-sm bg-green-950 rounded-lg px-4 py-3">
                Jeśli konto z tym adresem istnieje, wysłaliśmy link do resetu hasła. Sprawdź skrzynkę (i folder spam).
              </p>
            ...
            <form onSubmit={handle} className="space-y-4">
              ...
              <p className="text-center text-gray-400 text-sm">
                <Link to="/login" className="text-brand-500 hover:underline">Wróć do logowania</Link>
              </p>
            </form>
          )}
        </div>
